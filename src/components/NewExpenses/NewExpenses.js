...
const NewExpenses = () => {
    ...
    // useEffect(() => {
    //     const expenseSaved = {...expense};
    //     localStorage.setItem("expenseSaved", expenseSaved)
    // })

    // useEffect(() => {
    //     const expenseSaved = localStorage.getItem("expenseSaved");
    // }, expense)
    ...
    const handleSubmit = (event) => {
        ...
        setState([...expense, {description, amount, category, time} ]) //On doit maper dans un array donc il faut modifier notre state via un array
    ...
    return(
        <div className="d-flex flex-column justify-content-center w-100">
            ...
            <div className="list-container" data={() => expenseData(expense)}>
